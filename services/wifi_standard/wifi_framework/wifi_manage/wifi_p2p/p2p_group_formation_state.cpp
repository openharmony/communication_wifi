...
DEFINE_WIFILOG_P2P_LABEL("P2pGroupFormationState");
...
P2pGroupFormationState::P2pGroupFormationState(
    ...
    : State("P2pGroupFormationState"), p2pStateMachine(stateMachine), groupManager(groupMgr), deviceManager(deviceMgr)
{}
void P2pGroupFormationState::GoInState()
{
    WIFI_LOGI("             GoInState");
}

void P2pGroupFormationState::GoOutState()
{
