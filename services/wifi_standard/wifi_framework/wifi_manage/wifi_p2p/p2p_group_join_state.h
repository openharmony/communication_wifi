 ...
 */
#ifndef OHOS_P2P_GROUP_JOIN_STATE_H
#define OHOS_P2P_GROUP_JOIN_STATE_H
...
class P2pGroupJoinState : public State {
    FRIEND_GTEST(P2pGroupJoinState);

public:
    /**
     * @Description Construct a new P2pGroupJoinState object
     * @param None
     * @return None
     */
...
#endif /* OHOS_P2P_GROUP_JOIN_STATE_H */
