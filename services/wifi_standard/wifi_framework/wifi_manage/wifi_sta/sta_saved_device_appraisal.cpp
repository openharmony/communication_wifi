...
ErrCode StaSavedDeviceAppraisal::DeviceAppraisals(
    WifiDeviceConfig &electedDevice, std::vector<WifiScanInfo> &scanInfos, WifiLinkedInfo &info)
{
...
void StaSavedDeviceAppraisal::AppraiseDeviceQuality(
    int &score, WifiScanInfo &scanInfo, WifiDeviceConfig &device, WifiLinkedInfo &info)
{
