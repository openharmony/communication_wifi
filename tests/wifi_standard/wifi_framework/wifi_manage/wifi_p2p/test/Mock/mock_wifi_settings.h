...
public:
    ...
    virtual int GetP2pInfo(WifiP2pInfo &connInfo) = 0;
    virtual int SaveP2pInfo(WifiP2pInfo &connInfo) = 0;
...
public:
    ...
    MOCK_METHOD1(SaveP2pInfo, int(WifiP2pInfo &connInfo));
    MOCK_METHOD1(GetP2pInfo, int(WifiP2pInfo &connInfo));
