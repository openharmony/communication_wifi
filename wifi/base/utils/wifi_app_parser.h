...
struct HiGameExcludeAppInfo : CommonAppInfo {};
...
struct AppParserResult {
    ...
    std::vector<HiGameExcludeAppInfo> m_hiGameExcludeAppVec {};
...
public:
    ...
    bool IsHiGameExcludeApp(const std::string &bundleName) const;
