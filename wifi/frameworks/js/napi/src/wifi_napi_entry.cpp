...
static napi_value Init(napi_env env, napi_value exports) {
    ...
    napi_property_descriptor desc[] = {
        ...
        DECLARE_WRITABLE_NAPI_FUNCTION("getSignalLevel", GetSignalLevel),
        DECLARE_NAPI_FUNCTION("reconnect", ReConnect),
        DECLARE_NAPI_FUNCTION("reassociate", ReAssociate),
        DECLARE_WRITABLE_NAPI_FUNCTION("getIpInfo", GetIpInfo),
        DECLARE_WRITABLE_NAPI_FUNCTION("getIpv6Info", GetIpv6Info),
        DECLARE_WRITABLE_NAPI_FUNCTION("getLinkedInfo", GetLinkedInfo),
