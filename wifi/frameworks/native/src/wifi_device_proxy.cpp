...
void WifiDeviceProxy::WriteDeviceConfig(const WifiDeviceConfig &config, MessageParcel &data)
{
    ...
    data.WriteString(config.bssid.c_str());
    data.WriteString(config.ssid.c_str());
    ...
    data.WriteString(config.preSharedKey.c_str());
    data.WriteString(config.keyMgmt.c_str());
    for (int i = 0; i < WEPKEYS_SIZE; i++) {
        data.WriteString(config.wepKeys[i].c_str());
    }
    ...
    data.WriteString(config.wifiIpConfig.staticIpAddress.domains.c_str());
    data.WriteString(config.wifiEapConfig.eap.c_str());
    data.WriteString(config.wifiEapConfig.identity.c_str());
    data.WriteString(config.wifiEapConfig.password.c_str());
    data.WriteString(config.wifiEapConfig.clientCert.c_str());
    data.WriteString(config.wifiEapConfig.privateKey.c_str());
    ...
    data.WriteString(config.wifiProxyconfig.autoProxyConfig.pacWebAddress.c_str());
    data.WriteString(config.wifiProxyconfig.manualProxyConfig.serverHostName.c_str());
    data.WriteInt32(config.wifiProxyconfig.manualProxyConfig.serverPort);
    data.WriteString(config.wifiProxyconfig.manualProxyConfig.exclusionObjectList.c_str());
