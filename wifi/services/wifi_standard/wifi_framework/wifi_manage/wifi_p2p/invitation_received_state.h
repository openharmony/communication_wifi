...
#ifndef OHOS_P2P_INVITATION_RECEIVED_STATE_H
#define OHOS_P2P_INVITATION_RECEIVED_STATE_H
...
class InvitationReceivedState : public State {
    FRIEND_GTEST(InvitationReceivedState);

public:
    /**
     * @Description Construct a new Invitation Recelved State object
     * @param None
     * @return None
     */

    InvitationReceivedState(P2pStateMachine &, WifiP2pGroupManager &, WifiP2pDeviceManager &);
    /**
     * @Description Destroy the Invitation Recelved State object
     * @param None
     * @return None
     */
    ~InvitationReceivedState() = default;
...
#endif /* OHOS_P2P_INVITATION_RECELVED_STATE_H */
