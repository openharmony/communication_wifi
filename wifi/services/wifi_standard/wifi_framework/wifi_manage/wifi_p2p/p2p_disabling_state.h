 ...
 */
#ifndef OHOS_P2P_DISABLING_STATE_H
#define OHOS_P2P_DISABLING_STATE_H
...
class P2pDisablingState : public State {
    FRIEND_GTEST(P2pDisablingState);

public:
    /**
     * @Description Construct a new P2pDisablingState object
     * @param None
     * @return None
     */
    P2pDisablingState(P2pStateMachine &, WifiP2pGroupManager &, WifiP2pDeviceManager &);

    /**
     * @Description Destroy the P2pDisablingState object
     * @param None
     * @return None
     */
    ~P2pDisablingState() = default;
...
#endif /* OHOS_P2P_DISABLING_STATE_H */
