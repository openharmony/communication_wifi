 ...
 */
#ifndef OHOS_P2P_PENABLING_STATE_H
#define OHOS_P2P_PENABLING_STATE_H
...
class P2pEnablingState : public State {
    FRIEND_GTEST(P2pEnablingState);

public:
    /**
     * @Description Construct a new P2pEnablingState object
     * @param None
     * @return None
     */
    P2pEnablingState(P2pStateMachine &, WifiP2pGroupManager &, WifiP2pDeviceManager &);

    /**
     * @Description Destroy the P2pEnablingState object
     * @param None
     * @return None
     */
    ~P2pEnablingState() = default;
...
#endif /* OHOS_P2P_PENABLING_STATE_H */
