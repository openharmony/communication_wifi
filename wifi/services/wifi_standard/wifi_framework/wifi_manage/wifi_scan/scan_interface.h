...
public:
     ...
     * @return success: WIFI_OPT_SUCCESS, failed: WIFI_OPT_FAILED
     */
    ErrCode ScanWithParam(const WifiScanParams &wifiScanParams, bool externFlag,
        ScanType scanType = ScanType::SCAN_DEFAULT) override;
    /**
     ...
     * @return success: WIFI_OPT_SUCCESS, failed: WIFI_OPT_FAILED
     */
    ErrCode OnClientModeStatusChanged(int staStatus, int networkId = -1) override;
    /**
