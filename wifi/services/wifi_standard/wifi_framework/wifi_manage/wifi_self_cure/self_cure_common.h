...
#define WIFI_CURE_CMD_WIFI7_SELFCURE 151
#define WIFI_CURE_CMD_WIFI7_MLO_NO_INTERNET_SELFCURE 152
...
#define WIFI_CURE_CMD_FORCE_STOP_SELF_CURE 317
#define WIFI_CURE_DISCONNECT_TIMEOUT 318
#define WIFI_CURE_ON_DISCONNECT_TIMEOUT 319
#define SELFCURE_FAIL_LENGTH 8
#define SELFCURE_FAIL_HISTORY_LENGTH 14
#define SELFCURE_HISTORY_LENGTH 16
...
#define WIFI7_FAST_ARP_DETECTED_MS (1 * 1000)
...
#define DELAYED_TEN_MIN (10 * 60 * 1000)
...
#define WIFI_BLA_LIST_TIME_EXPIRED (2 * 60 * 60 * 1000)
...
constexpr int32_t WIFI_CURE_DISCONNECT_TIMEOUT_MS = 2 * 1000;
constexpr int32_t WIFI_CURE_ON_DISCONNECT_TIMEOUT_MS = 1 * 1000;
