...
enum SelfCureHistoryOrder {
    POS_STATIC_IP_FAILED_CNT,
    POS_STATIC_IP_FAILED_TS,
    POS_REASSOC_FAILED_CNT,
    POS_REASSOC_FAILED_TS,
    POS_RANDMAC_FAILED_CNT,
    POS_RANDMAC_FAILED_TS,
    POS_RESET_FAILED_CNT,
    POS_RESET_FAILED_TS,
    POS_REASSOC_CONNECT_FAILED_CNT,
    POS_REASSOC_CONNECT_FAILED_TS,
    POS_RANDMAC_CONNECT_FAILED_CNT,
...
enum SelfCureState {
    ...
    SCE_WIFI_DISCONNECT_STATE,
    SCE_WIFI_ON_DISCONNECT_MIDDLE_STATE,
};
