...
#define WIFI_SVR_CMD_STA_REDHCP 0x3026
#define WIFI_SVR_CMD_STA_WPA_AUTH_TIMEOUT_EVENT 0x3027
...
enum SelectedType {
    ...
    NETWORK_SELECTED_BY_HILINK = 8,
    NETWORK_SELECTED_BY_GENELINK = 9,
    NETWORK_SELECTED_BY_FAST_RECONNECT = 10,
    NETWORK_SELECTED_BY_WIFIPRO_ENHANCE = 11,
    NETWORK_SELECTED_BY_BACKGROUND_PORTAL = 12
};
...
enum NetworkFailReason {
    ...
    IPV6_STATE_UNREACHABLE_WLAN1,
    IPV6_STATE_FAILED_DISABLE,
};
