...
{
    const std::string NET_BEAR_TYPE_KEY = "NetType";
    const int32_t NET_BEAR_TYPE_DEFAULT = -1;
    int32_t bearType = eventData.GetWant().GetIntParam(NET_BEAR_TYPE_KEY, NET_BEAR_TYPE_DEFAULT);
