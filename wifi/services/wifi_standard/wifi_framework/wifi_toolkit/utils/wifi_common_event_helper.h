...
inline const std::string COMMON_EVENT_WIFI_SCAN_ONLY_STATE_CHANGED = "usual.event.wifi.SCAN_ONLY_STATE_CHANGED";
...
public:
    ...
    static bool PublishScanOnlyStateChangedEvent(const int &code, const std::string &data);
