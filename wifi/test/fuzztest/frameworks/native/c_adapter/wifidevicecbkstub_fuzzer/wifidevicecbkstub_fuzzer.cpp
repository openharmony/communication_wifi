...
std::shared_ptr<WifiDeviceCallBackStub> pWifiDeviceCallStub = std::make_shared<WifiDeviceCallBackStub>();
...
bool DoSomethingInterestingWithMyAPI(const uint8_t* data, size_t size)
{
    ...
    pWifiDeviceCallStub->OnRemoteRequest(code, datas, reply, option);
    return true;
}
