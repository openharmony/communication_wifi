...
std::map<int, sptr<IRemoteObject>> &deviceServiceMgr = WifiDeviceMgrServiceImpl::GetInstance()->GetDeviceServiceMgr();
sptr<WifiDeviceStub> pWifiDeviceStub = iface_cast<WifiDeviceServiceImpl>(deviceServiceMgr[0]);
