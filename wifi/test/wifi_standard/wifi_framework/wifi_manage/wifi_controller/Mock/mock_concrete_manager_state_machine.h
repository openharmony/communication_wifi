 ...
 */
#ifndef OHOS_MOCK_CONCRETESTATEMACHINE_H
#define OHOS_MOCK_CONCRETESTATEMACHINE_H
...
namespace OHOS {
namespace Wifi {
class MockConcreteMangerMachine : public ConcreteMangerMachine {
public:
    MockConcreteMangerMachine() {}
    ~MockConcreteMangerMachine() {}
