 ...
 */
#ifndef MOCK_GROUP_FORMED_STATE_H
#define MOCK_GROUP_FORMED_STATE_H
#include <gmock/gmock.h>
#include "group_formed_state.h"
namespace OHOS {
namespace Wifi {
class MockGroupFormedState : public GroupFormedState {
public:
    MockGroupFormedState(
        P2pStateMachine &p2pStateMachine, WifiP2pGroupManager &groupManager, WifiP2pDeviceManager &deviceManager)
        : GroupFormedState(p2pStateMachine, groupManager, deviceManager)
    {}
    ~MockGroupFormedState() = default;
