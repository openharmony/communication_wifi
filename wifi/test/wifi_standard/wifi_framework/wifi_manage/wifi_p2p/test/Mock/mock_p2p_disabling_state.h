 ...
 */
#ifndef MOCK_P2P_DISABLING_STATE_H
#define MOCK_P2P_DISABLING_STATE_H
#include <gmock/gmock.h>
#include "p2p_disabling_state.h"
namespace OHOS {
namespace Wifi {
class MockP2pDisablingState : public P2pDisablingState {
public:
    MockP2pDisablingState(
        P2pStateMachine &p2pStateMachine, WifiP2pGroupManager &groupManager, WifiP2pDeviceManager &deviceManager)
        : P2pDisablingState(p2pStateMachine, groupManager, deviceManager)
    {}
    ~MockP2pDisablingState() = default;
