 ...
 */
#ifndef MOCK_P2P_ENABLED_STATE_H
#define MOCK_P2P_ENABLED_STATE_H
#include <gmock/gmock.h>
#include "p2p_enabled_state.h"
namespace OHOS {
namespace Wifi {
class MockP2pEnabledState : public P2pEnabledState {
public:
    MockP2pEnabledState(
        P2pStateMachine &p2pStateMachine, WifiP2pGroupManager &groupManager, WifiP2pDeviceManager &deviceManager)
        : P2pEnabledState(p2pStateMachine, groupManager, deviceManager)
    {}
