 ...
 */
#ifndef MOCK_P2P_IDLE_STATE_H
#define MOCK_P2P_IDLE_STATE_H
#include <gmock/gmock.h>
#include "p2p_idle_state.h"
namespace OHOS {
namespace Wifi {
class MockP2pIdleState : public P2pIdleState {
public:
    MockP2pIdleState(
        P2pStateMachine &p2pStateMachine, WifiP2pGroupManager &groupManager, WifiP2pDeviceManager &deviceManager)
        : P2pIdleState(p2pStateMachine, groupManager, deviceManager)
    {}
    ~MockP2pIdleState() = default;
