...
#ifndef MOCK_P2P_INVITING_STATE_H
#define MOCK_P2P_INVITING_STATE_H
#include <gmock/gmock.h>
#include "p2p_inviting_state.h"
namespace OHOS {
namespace Wifi {
class MockP2pInvitingState : public P2pInvitingState {
public:
    MockP2pInvitingState(
        P2pStateMachine &p2pStateMachine, WifiP2pGroupManager &groupManager, WifiP2pDeviceManager &deviceManager)
        : P2pInvitingState(p2pStateMachine, groupManager, deviceManager)
    {}
