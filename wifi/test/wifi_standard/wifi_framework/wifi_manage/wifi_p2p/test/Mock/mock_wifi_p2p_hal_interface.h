...
public:
    ...
    virtual WifiErrorNo P2pCancelWpsPbc(const std::string &groupInterface) const = 0;
};
...
public:
    ...
    MOCK_CONST_METHOD1(P2pCancelWpsPbc, WifiErrorNo(const std::string &groupInterface));
};
}  // namespace Wifi
}  // namespace OHOS
#endif
