...
namespace Wifi {
    ...
    void P2pDisablingStateCallback(const LogType type,const LogLevel level,const unsigned int domain ,const char *tag,const char *msg)
    {
        g_errLog = msg;
    }
...
public:
    ...
    virtual void SetUp()
    {
        ...
        pP2pDisablingState.reset(
            ...
            LOG_SetCallback(P2pDisablingStateCallback);
    }
