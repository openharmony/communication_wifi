...
public:
    ...
    virtual void OnConnectChangedCallBack(int status, int networkId, const std::string &bssid, int locallyGenerated) = 0;
...
public:
    ...
    MOCK_METHOD4(OnConnectChangedCallBack, void(int status, int networkId, const std::string &bssid, int locallyGenerated));
