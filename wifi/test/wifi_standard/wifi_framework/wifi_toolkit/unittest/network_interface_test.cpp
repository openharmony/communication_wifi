...
public:
    BaseAddressSubClass(const std::string ip, BaseAddress::FamilyType familyType)
 ...
 * @tc.require: issue
*/
HWTEST_F(WifiNetworkInterfaceTest, GetIpv4Address_001, TestSize.Level1)
{
 ...
 * @tc.require: issue
*/
HWTEST_F(WifiNetworkInterfaceTest, GetAllIpv6Address_001, TestSize.Level1)
{
    WIFI_LOGI("GetAllIpv6Address_001 enter");
    std::vector<Ipv6Address> vecIPv6;
    EXPECT_FALSE(NetworkInterface::GetAllIpv6Address("test", vecIPv4));
    EXPECT_TRUE(NetworkInterface::GetAllIpv6Address("wlan0", vecIPv4));
}
/**
 ...
 * @tc.require: issue
*/
HWTEST_F(WifiNetworkInterfaceTest, IsExistAddressForInterface_001, TestSize.Level1)
{
    ...
    EXPECT_FALSE(NetworkInterface::IsExistAddressForInterface("lo", address2));
 ...
 * @tc.require: issue
*/
HWTEST_F(WifiNetworkInterfaceTest, AddIpAddress_001, TestSize.Level1)
{
 ...
 * @tc.require: issue
*/
HWTEST_F(WifiNetworkInterfaceTest, DelIpAddress_001, TestSize.Level1)
{
    WIFI_LOGI("DelIpAddress_001 enter");
    BaseAddressTest address1 = BaseAddressTest("192.168", BaseAddress::FamilyType::FAMILY_INET);
    EXPECT_FALSE(NetworkInterface::DelIpAddress("test", address1));
    BaseAddressTest address2 = BaseAddressTest("127.0.0.1", BaseAddress::FamilyType::FAMILY_INET);
    EXPECT_FALSE(NetworkInterface::DelIpAddress("test", address2));
 ...
 * @tc.require: issue
*/
HWTEST_F(WifiNetworkInterfaceTest, ClearAllIpAddress_001, TestSize.Level1)
{
 ...
 * @tc.require: issue
*/
HWTEST_F(WifiNetworkInterfaceTest, IpAddressChange_001, TestSize.Level1)
{
