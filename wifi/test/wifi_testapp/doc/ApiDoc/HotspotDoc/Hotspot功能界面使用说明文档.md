...
​		本文档主要介绍了热点专项测试程序的Hotspot部分（@ohos.wifi.d.ts）的功能使用说明。
...
1. 开/关热点 （ enableHotspot/disableHotspot ）   
   ...
   **方法是异步的**
   ...
   enableHotspot :  启用 Wi-Fi 热点后，Wi-Fi 可能会被禁用。
   ...
   - 限制条件：
     ...
     - 若热点未开，点击"开热点"，显示信息为"true"；
     - 若热点未开，点击"开热点"，发生错误，显示信息为"false"；
     - 若热点已打开，点击"开热点"，显示信息为"热点已经使能"。
     - 若热点已打开，点击"关热点"，显示结果为"true"；
     - 若热点已打开，点击"关热点"，发生错误，显示信息为"false"；
     - 若热点未打开，点击"关热点"，显示结果为"热点未使能"。
...
9.  订阅/取消订阅注册热点离开改变事件on.hotspotStaLeave
