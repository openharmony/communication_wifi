...
2. 下载链接: [DevEco Studio和SDK下载和升级](https://developer..com/cn/develop/deveco-studio#download_beta)

3. 安装步骤: [下载与安装软件-快速开始 DevEco Studio For OpenHarmony使用指南-工具](https://developer..com/cn/docs/documentation/doc-guides/ohos-download-software-0000001218760592)  

注：建议在选项界面都勾选DevEco Studio，Add “bin” folder to the PATH，Add "Open Folder as Project"

4. 配置开发环境：[配置开发环境-快速开始-HUAWEI DevEco Studio For OpenHarmony使用指南-工具](https://developer..com/cn/docs/documentation/doc-guides/ohos-setting-up-environment-0000001263160443)
...
![image-20230413101138838](InstructionDoc\stress测试界面.png)
