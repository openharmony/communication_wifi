...
inline const int SIGNAL_RECORD_3S = 3;
...
extern const std::map<std::string, int> g_staCallBackNameEventIdMap;

/* ApCallBackNameEventIdMap */
extern const std::map<std::string, int> g_apCallBackNameEventIdMap;

/* P2PCallBackNameEventIdMap */
extern const std::map<std::string, int> g_p2pCallBackNameEventIdMap;
