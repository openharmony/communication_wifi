...
const std::map<std::string, int> g_staCallBackNameEventIdMap = {
...
const std::map<std::string, int> g_apCallBackNameEventIdMap = {
...
const std::map<std::string, int> g_p2pCallBackNameEventIdMap = {
